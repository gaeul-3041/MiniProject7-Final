...
public class LogService {
    ...
    public void saveLog(List<HospitalResponse> hospitalResponseList, String request, double latitude, double longitude, int emClass) {
        ...
        List<HospitalResponse> top3Hospitals = hospitalResponseList.stream()
                .limit(3) // 상위 3개 병원 제한
                .collect(Collectors.toList());

        int count = 1;
        for (HospitalResponse hospitalResponse : top3Hospitals) {
            ...
            switch (count) {
                case 1:
                    ...
                    hospitalLog.setHospital1ArrivalTime(hospitalResponse.getArrivalTime());
                    hospitalLog.setHospital1Duration(hospitalResponse.getDuration());
                    break;
                case 2:
                    ...
                    hospitalLog.setHospital2ArrivalTime(hospitalResponse.getArrivalTime());
                    hospitalLog.setHospital2Duration(hospitalResponse.getDuration());
                    break;
                case 3:
                    ...
                    hospitalLog.setHospital3ArrivalTime(hospitalResponse.getArrivalTime());
                    hospitalLog.setHospital3Duration(hospitalResponse.getDuration());
                    break;
            }
            count++;
        }
